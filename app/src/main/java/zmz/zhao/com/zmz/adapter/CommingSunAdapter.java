 ...
 * function:
 */
public class CommingSunAdapter extends RecyclerView.Adapter<CommingSunAdapter.ViewHolder>{
    Context context;
    List<ShowLunBoBean> mBeanList;

    public CommingSunAdapter(Context context) {
    ...
    @NonNull
    @Override
    public CommingSunAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = View.inflate(context, R.layout.recyclergrild_item, null);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CommingSunAdapter.ViewHolder viewHolder, int i) {
